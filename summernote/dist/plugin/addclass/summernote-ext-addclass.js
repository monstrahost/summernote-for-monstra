...
(function (factory) {
    ...
    $.extend($.summernote.plugins, {
        ...
        'addclass': function (context) {
            ...
            addStyleString(".scrollable-menu {height: auto; max-height: 300px; max-width:400px; overflow-x: hidden;}");

            context.memo('button.addclass', function () {
                return ui.buttonGroup([
                    ui.button({
                        className: 'dropdown-toggle',
                        contents: ui.icon(context.options.icons.magic) + ' ' + ui.icon(context.options.icons.caret, 'span'),
                    ...
                    ui.dropdown({
                        ...
                        click: function (event, namespace, value) {
                            ...
                            context.invoke('getSelectedText');
